...
1. 用户要求时提交当前“每场两阶段”模式及交接文档修改；提交前不要 reset。当前涉及 `config.example.yaml`、`polybtc/config.py`、`polybtc/dashboard.py`、`polybtc/pair_match.py`、`tests/test_dashboard.py`、`tests/test_pair_match.py`、`web/index.html` 和 `HANDOFF.md`。
